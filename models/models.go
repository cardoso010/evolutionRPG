		...
		Cave{
			...
			Creature: []Creature{
				Creature{
					Name:  "Dragon lord",
					Exp:   1000,
					Skill: Skill{Force: 70, Defense: 50},
					Hp:    1000,
				},
				Creature{
					Name:  "Fire lord",
					Exp:   100,
					Skill: Skill{Force: 40, Defense: 40},
					Hp:    120,
				},
			},
		},
		Cave{
			...
			Creature: []Creature{
				Creature{
					Name:  "Earthworm",
					Exp:   50,
					Skill: Skill{Force: 35, Defense: 20},
					Hp:    70,
				},
				Creature{
					Name:  "Mouse",
					Exp:   10,
					Skill: Skill{Force: 20, Defense: 20},
					Hp:    20,
				},
			},
		},
